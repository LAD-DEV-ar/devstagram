        ...
        <form action="{{ route('register')}}" method="POST" novalidate>
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    type="text"
                    class="focus:outline-none focus:border-blue-500 border border-gray-200 rounded-lg p-3 w-full bg-white @error('name') border-red-500 @enderror"
                    value="{{ old('name') }}" />
                @error('name')
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    type="text"
                    class="focus:outline-none focus:border-blue-500 border border-gray-200 rounded-lg p-3 w-full bg-white @error('username') border-red-500 @enderror"
                    value="{{ old('username') }}" />
                @error('username')
                <p class="bg-red-500 text-white my-2 rounded-lg text-sm p-2 text-center font-semibold uppercase">{{$message}}</p>
                @enderror
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    type="password"
                    class="focus:outline-none focus:border-blue-500 border border-gray-200 rounded-lg p-3 w-full bg-white @error('password_confirmation') border-red-500 @enderror"
